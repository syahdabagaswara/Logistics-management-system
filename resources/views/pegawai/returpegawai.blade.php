                    ...
                    <li class="menu-item-has-children dropdown show open">
                        ...
                        <ul class="sub-menu children dropdown-menu  show">
                           <li ><i class="  fa fa-circle "></i><a  href="datapegawai">Data Pegawai</a></li>
                            ...
                            <li><i class=" active fa fa-circle"></i><a class="active" href="returpegawai">Retur Penjualan</a></li>
        ...
        <div class="content pb-0">
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                   <thead>
                                    ...
                                    <tbody>
                                        @foreach($data as $returPegawai)
                                        <tr>
                                            <td>{{$returPegawai->kode}}</td>
                                            <td>{{$returPegawai->namabarang}}</td>
                                            <td>{{$returPegawai->namapegawai}}</td>
                                            <td>{{$returPegawai->jumlah}}</td>
                                            <td><?php echo date('M d, Y', strtotime($returPegawai->tanggal)); ?></td>
                                            <td><button type='button' class='editdata' data-toggle='modal' data-target='#largeModal' data-info="{{$returPegawai->kode}},{{$returPegawai->namabarang}},{{$returPegawai->namapegawai}},{{$returPegawai->jumlah}},{{$returPegawai->tanggal}}">Edit</button><button type='button' class='deletedata' data-toggle='modal' data-target='#deletedata' data-info="{{$returPegawai->kode}},{{$returPegawai->namabarang}},{{$returPegawai->namapegawai}},{{$returPegawai->jumlah}},{{$returPegawai->tanggal}}">Hapus</button></td>
                                        </tr>
                                        @endforeach
                                    </tbody> 
            ...
            <div class="modal fade" id="mediumModal" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <form id="tambah" method="POST" action="{{url('returPegawaiAdd')}}">
                        {{ csrf_field() }}
                        <div class="modal-header">
                            <a class="modal-title" id="mediumModalLabel">Tambah Retur Penjualan</a>
            ...
            <div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" >
                    <div class="modal-content">
                    <form id="editdata" method="POST" action="{{ url('returPegawaiUpdate') }}">
                        {{ csrf_field() }}
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="row form-space">
                                <div class="col-lg-3 text-left">
                                    <div class="form-tambah">
                                        <a >Kode Retur Penjualan</a>
                                    </div>
                                </div>
                                <div class="col-lg-5 text-left">
                                    <input  type="text" id="ubahkodepenjualan" name="ubahkodepenjualan"  class="form-control form-input" readonly>
                                </div>
                            </div>
                            <div class="row form-space">
                                <div class="col-lg-3 text-left">
                            ...
                            <div class="row form-space">
                                ...
                                <div class="col-lg-5 text-left">
                                    <input  type="text" id="ubahtanggalmasuk" name="ubahtanggalmasuk"  class="form-control form-input" readonly>
                                </div>
                            </div>
            ...
            <div class="modal fade" id="largeModal1" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">
             ...
             <div class="modal fade" id="deletedata" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" >
                    <div class="modal-content">
                    <form id="" method="POST" action="{{url('returPegawaiDelete')}}">
                        {{csrf_field()}}
                        <div class="modal-header">
    ...
    <script type="text/javascript">
     ...
     <script type="text/javascript">
        ...
        function fillmodalData(details){
            $('#ubahkodepenjualan').val(details[0]);
            $('#ubahnamabarang').find(':selected').val(details[0]).text(details[1]);
