...
<body ">
                    ...
                    <li class="menu-item-has-children dropdown show open">
                        ...
                        <ul class="sub-menu children dropdown-menu  show">
                           <li ><i class="  fa fa-circle "></i><a  href="datapegawai">Data Pegawai</a></li>
                            ...
                            <li><i class="active fa fa-circle"></i><a class="active" href="setoran">Setoran</a></li>
        ...
        <div class="content pb-0">
            ...
            <div class="row" style="margin-bottom: 30px">
                <div class="col-lg-3 col-md-6">
                    <h3 style="color:#8c8e8d;"><b>Setoran</b></h3>
                </div>
            ...
            <div class="modal fade" id="mediumModal" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content" style="width: 756px;left:60px;">
                    <form id="msform" action="">
                        ...
                        <div class="modal-body">
                             <ul id="progressbar">
                                    <li style="margin-left: 65px" class="active"><p>Nota<p></li>
                                    <li style="margin-left: -213px"><p>Detail Barang<p></li>
                            ...
                            <div class="row form-space">
                                ...
                                <div class="col-lg-5 text-left">
                                  <select data-placeholder="" type="text" id="nomornota" name="nomornota" class=" form-control form-input standardSelect required" tabindex="1"> 
                                        <option  class="option" value=""  selected>Nomor Nota</option>
                            ...
                            <div id="form">
                                <div class="row head-table-wid" id="registration1" style="border-top: 1px solid #f2f2f2">
                                    ...
                                    <div class="col-md-3 text-center" style="margin-left:30px;max-width: 190px!important;">
                                        ...
                                        <label>Deskripsi</label>
                                            <input  type="text" id="deskripsi" name="deskripsi[]" placeholder="0" class="form-control form-input-wizard">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 text-center">
                                        <div class="form-group">
                                            <label>Cash</label>
                                            <input  type="text" id="cash" name="cash[]" placeholder="0" class="form-control form-input-wizard">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 text-center">
                                        <div class="form-group">
                                            ...
                                            <input  type="text" id="bon" name="bon[]" placeholder="0" class="form-control form-input-wizard">
                                        </div>
                                    </div>
                                    <div class="col-md-2 text-center">
                                        <div class="form-group">
                                            <label>Total Harga</label>
                                            <input  type="text" id="tambahtotal" name="tambahtotal[]" placeholder="0" class="form-control form-input-wizard">
                                        </div>
                                    </div>
                                ...
                                <input  type="submit" name="submit" class="submit action-button btn btn-success" value="Tambah">
                        </fieldset>
        ...
        $(document).ready(function() {
                         $('input.global_filter').on( 'keyup click', function () {
                          ...
                          var table = $('#bootstrap-data-table').DataTable({
                            ...
                            "targets": -1,
                            "data": null,
                            "defaultContent": "<a href='detailsetoran?kode='><button type='button' class='detaildata' >Detail</button></a>"
                            } ],
                            lengthChange: false,
                            data: dataSet,
                            columns: [{
    ...
    <script type="text/javascript">
        //  Insert content with the append() method.
            ...
            rowCount ++;
            var recRow = '<div class="row head-table-wid" id="registrations'+rowCount+'"  style="border-top: 1px solid #f2f2f2"><div class="col-md-3 text-center" style="margin-left:30px;max-width: 190px!important;"><div class="form-group"><select data-placeholder="" type="text" id="name'+rowCount+'" name="name'+rowCount+'" class=" form-control form-input standardSelect " tabindex="1">                                                 <option  class="option" value=""  selected>Pilih Jenis Barang</option>                                                <option value="United States">A</option>                                                <option value="United Kingdom">B</option>                                        </select>                                        </div>                                        </div>                                        <div class="col-md-3 text-center">                                        <div class="form-group">                                                                                <input  type="text" id="mobile'+rowCount+'" name="mobile'+rowCount+'" placeholder="0" class="form-control form-input-wizard">                                        </div>                                        </div>                                        <div class="col-md-3 text-center">                                        <div class="form-group">                                                                                                                        <input  type="text" id="email'+rowCount+'" name="email'+rowCount+'" placeholder="0" class="form-control form-input-wizard">                                        </div>                                        </div>                                        <div class="col-md-2 text-center">                                        <div class="form-group">                                                                                <input  type="text" id="email'+rowCount+'" name="email'+rowCount+'" placeholder="0" class="form-control form-input-wizard">                                        </div>                                        </div>                                        <div class="col-md-1">                                        <a href="javascript:void(0);" onclick="removeRows('+rowCount+');" style="float:left;" class="fieldsbutton"> Hapus</a>                                            </div>                                        </div>';
            jQuery('#largeModal #addedRowss').append(recRow);
            $('select').niceSelect();
            };
            var rowCounts = 1;
            ...
            rowCounts ++;
            var recRow = '<div class="row head-table-wid" id="registration'+rowCounts+'"  style="border-top: 1px solid #f2f2f2"><div class="col-md-3 text-center" style="margin-left:30px;max-width: 190px!important;"><div class="form-group"><select data-placeholder="" type="text" id="name'+rowCounts+'" name="name'+rowCounts+'" class=" form-control form-input standardSelect " tabindex="1">                                                 <option  class="option" value=""  selected>Pilih Jenis Barang</option>                                                <option value="United States">A</option>                                                <option value="United Kingdom">B</option>                                        </select>                                        </div>                                        </div>                                        <div class="col-md-3 text-center">                                        <div class="form-group">                                                                                <input  type="text" id="mobile'+rowCounts+'" name="mobile'+rowCounts+'" placeholder="0" class="form-control form-input-wizard">                                        </div>                                        </div>                                        <div class="col-md-3 text-center">                                        <div class="form-group">                                                                                                                        <input  type="text" id="email'+rowCounts+'" name="email'+rowCounts+'" placeholder="0" class="form-control form-input-wizard">                                        </div>                                        </div>                                        <div class="col-md-2 text-center">                                        <div class="form-group">                                                                                <input  type="text" id="email'+rowCounts+'" name="email'+rowCounts+'" placeholder="0" class="form-control form-input-wizard">                                        </div>                                        </div>                                        <div class="col-md-1">                                        <a href="javascript:void(0);" onclick="removeRow('+rowCounts+');" style="float:left;" class="fieldsbutton"> Hapus</a>                                            </div>                                        </div>';
            ...
            function removeRows(removeNums) {
                
            if(removeNums == 1){
                alert("Cannot Delete this Row");
                return false;
            } else {    
            jQuery('#largeModal #registrations'+removeNums).remove(); 
            }
