                    ...
                    <li class="menu-item-has-children dropdown show open">
                        ...
                        <ul class="sub-menu children dropdown-menu  show">
                           <li ><i class="  fa fa-circle "></i><a  href="datapegawai">Data Pegawai</a></li>
                            ...
                            <li><i class=" active fa fa-circle"></i><a class="active" class="" href="komisi">Komisi</a></li>
        ...
        <div class="content pb-0">
            ...
            <div class="row">
                <div class="col-lg-12">
                        <div class="card" >
                            <div class="card-body">
                                <b style="margin:0px 0px 0px 10px;">Detail Data Komisi</b>
                        ...
                        <div style="margin-bottom: 50px;margin-top: 10px;">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                <b style="margin:0px 0px 0px 10px;">Pemasukan</b>
                                <div class="row form-space-detail" >
                                    <div class="col-lg-6 text-left " style="border-top: 1px solid #e5e5e5;">
                                        <div class="form-tambah-separator">
                                            <a >Keuntungan</a>
                                        </div>
                                    </div>
                                    <div class="col-lg-1 text-left " style="border-top: 1px solid #e5e5e5;">
                                        <div class="form-tambah-separator">
                                            <a >:</a>
                                        </div>
                                    </div>
                                    <div class="col-md-5 text-left " style="border-top: 1px solid #e5e5e5;">
                                        <div class="form-tambah-separator">
                                            <a ></a>
                                        </div>
                                    </div>
                                ...
                                <div class="row form-space-detail" >
                                    <div class="col-md-6 text-left " style="border-top: 1px solid #e5e5e5;">
                                        <div class="form-tambah-separator">
                                            <a >Penerima Lain-Lain</a>
                                        </div>
                                    </div>
                                    <div class="col-md-1 text-left f" style="border-top: 1px solid #e5e5e5;">
                                        <div class="form-tambah-separator">
                                            <a >:</a>
                                        </div>
                                    </div>
                                    <div class="col-lg-5 text-left form-detail" style="border-top: 1px solid #e5e5e5;">
                                        <div class="form-tambah-separator">
                                            <a ></a>
                                        </div>
                                    </div>
                                ...
                                <div class="row form-space-detail" >
                                    <div class="col-md-6 text-left " style="border-top: 1px solid #e5e5e5;border-bottom: 1px solid #e5e5e5;">
                                        <div class="form-tambah-separator">
                                            <a >Total</a>
                                        </div>
                                    </div>
                                    <div class="col-md-1 text-left " style="border-top: 1px solid #e5e5e5;border-bottom: 1px solid #e5e5e5;">
                                        <div class="form-tambah-separator">
                                            <a >:</a>
                                        </div>
                                    </div>
                                    <div class="col-lg-5 text-left form-detail" style="">
                                        <div class="form-tambah-separator">
                                            <a ></a>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <b style="margin:0px 0px 0px 10px;">Biaya Operasional</b>
                                <div class="row form-space-detail" >
                                    <div class="col-lg-6 text-left " style="border-top: 1px solid #e5e5e5;">
                                        <div class="form-tambah-separator">
                                            <a >bahan bakar</a>
             ...
             <div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" >
                    ...
                    <form id="editdataproduk" method="" action="">
                        <div class="modal-header">
                            <a class="modal-title" id="largeModalLabel">Ubah Data</a>
                        ...
                        <div class="modal-body">
                            <div class="row form-space">
                                ...
                                <div class="col-lg-5 text-left">
                                    <input  type="text" id="ubahdeskripsi" name="ubahdeskripsi" placeholder="Masukan Deskripsi" class="required form-control form-input">
                                </div>
                            </div>
                            <div class="row form-space">
                                ...
                                <div class="col-lg-5 text-left">
                                    <input  type="text" id="ubahcash" name="ubahcash" placeholder="Masukan Cash" class="required form-control form-input">
                            ...
                            <div class="row form-space">
                                ...
                                <div class="col-lg-5 text-left">
                                    <input  type="text" id="ubahbon" name="ubahbon" placeholder="Masukan Bon" class="required form-control form-input">
                            ...
                            <div class="row form-space">
                                ...
                                <div class="col-lg-5 text-left">
                                    <input  type="text" id="ubahtotalharga" name="ubahtotalharga" placeholder="Masukan Total Harga" class="required form-control form-input">
            ...
            <div class="modal fade" id="deletedata" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" >
                    ...
                    <form id="" method="POST" action="">
                        ...
                        <div class="modal-header">
                            <a class="modal-title" id="largeModalLabel">Hapus Data </a>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
             ...
             <div class="modal fade" id="mediumModal" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <form id="tambahdataproduk" method="" action="">
                       
                        <div class="modal-header">
                            <a class="modal-title" id="mediumModalLabel">Tambah Data </a>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                         <div class="modal-body">
                            <div class="row form-space">
                                ...
                                <div class="col-lg-5 text-left">
                                    <input  type="text" id="deskripsi" name="deskripsi" placeholder="Masukan Deskripsi" class="required form-control form-input">
                                </div>
                            </div>
                            <div class="row form-space">
                                ...
                                <div class="col-lg-5 text-left">
                                    <input  type="text" id="cash" name="cash" placeholder="Masukan Cash" class="required form-control form-input">
                            ...
                            <div class="row form-space">
                                ...
                                <div class="col-lg-5 text-left">
                                    <input  type="text" id="bon" name="bon" placeholder="Masukan Bon" class="required form-control form-input">
    ...
    <script type="text/javascript">
     ...
     <script type="text/javascript">
        ...
        function fillmodalData(details){
            $('#ubahdeskripsi').val(details[0]);
            $('#ubahcash').val(details[1]);
            $('#ubahbon').val(details[2]);
            $('#ubahtotalharga').val(details[3]);   
        }
    </script>
