...
<body ">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown show open">
                        ...
                        <ul class="sub-menu children dropdown-menu  show">
                           <li ><i class="active fa fa-circle "></i><a class="active"  href="datatoko">Data Toko</a></li>
        ...
        <div class="content pb-0">
            ...
            <div class="row" style="margin-bottom: 30px">
                <div class="col-lg-3 col-md-6">
                    <h3 style="color:#8c8e8d;"><b>Data Toko</b></h3>
                </div>
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    @foreach($data as $i)                        
                                        <tr>
                                            ...
                                            <td>{{ $i->alamat }}</td>
                                            <td>{{ $i->no_tlp }}</td>
                                            <td><button type='button' class='editdata' data-toggle='modal' data-target='#largeModal' data-info="{{$i->kode}},{{$i->nama}},{{$i->alamat}},{{$i->no_tlp}}">Edit</button><button type='button' class='deletedata' data-toggle='modal' data-target='#deletedata' data-info="{{$i->kode}},{{$i->nama}},{{$i->alamat}},{{$i->no_tlp}}">Hapus</button></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
            ...
            <div class="modal fade" id="mediumModal" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <form id="tambahdataToko" method="POST" action="{{ url('pelangganAdd') }}">
                            {{ csrf_field() }}
                        <div class="modal-header">
                            <a class="modal-title" id="mediumModalLabel">Tambah Data Toko</a>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row form-space">
                                ...
                                <div class="col-lg-5 text-left">
                                    <input  type="text" id="namatoko" name="namatoko" placeholder="Masukan Nama Toko" class="required form-control form-input">
                            ...
                            <div class="row form-space">
                                ...
                                <div class="col-lg-5 text-left">
                                    <input  type="text" id="alamattoko" name="alamattoko" placeholder="Masukan Alamat Toko" class="required form-control form-input">
            ...
            <div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" >
                    <div class="modal-content">
                    <form id="editdataToko" method="POST" action="{{ url('pelangganUpdate') }}">
                    {{ csrf_field() }}
                        <div class="modal-header">
                            <a class="modal-title" id="largeModalLabel">Ubah Data Toko</a>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                         <div class="modal-body">
                            <div class="row form-space">
                                ...
                                <div class="col-lg-5 text-left">
                                    <input  type="text" id="ubahkodetoko" name="ubahkodeToko"  class="form-control form-input" value="SAE12345678" readonly>
                                </div>
                            </div>
                            <div class="row form-space">
                                ...
                                <div class="col-lg-5 text-left">
                                    <input  type="text" id="ubahnamatoko" name="ubahnamatoko" placeholder="Masukan Nama Toko" class="required form-control form-input">
                            ...
                            <div class="row form-space">
                                ...
                                <div class="col-lg-5 text-left">
                                    <input  type="text" id="ubahalamattoko" name="ubahalamattoko" placeholder="Masukan Alamat Toko" class="required form-control form-input">
                            ...
                            <div class="row form-space">
                                ...
                                <div class="col-lg-5 text-left">
                                    <input  type="text" id="ubahnomor" name="ubahnomor" placeholder="Masukan Nomor Handphone" class="required form-control form-input">
             ...
             <div class="modal fade" id="deletedata" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" >
                    <div class="modal-content">
                    <form id="" method="POST" action="{{ url('pelangganDelete') }}">
                        {{ csrf_field() }}
                        <div class="modal-header">
                            <a class="modal-title" id="largeModalLabel">Hapus Data Toko</a>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
    ...
    <script type="text/javascript">
            ...
            $(document).ready(function() {
              ...
              var table=$('#bootstrap-data-table').DataTable({
                ...
                var column = this;
                var select = $('<select class="form-control btn btn-primary placeholder "><option value="">Toko</option><option value="">Semua</option></select>')
                    .appendTo( $('#filterToko').empty() )
                    .on( 'change', function () {
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#mediumModal').on('hidden.bs.modal', function () {
                ...
                $('#tambahdataToko').prop('selectedIndex',0);
                $('#tambahdataToko').validate().resetForm();
                $('.error').removeClass('error');
            });
            $('#largeModal').on('hidden.bs.modal', function () {
                
                $('#editdataToko').prop('selectedIndex',0);
                $('#editdataToko').validate().resetForm();
                $('.error').removeClass('error');
            });
            $('#tambahdataToko').validate({
             ignore: [],
            rules: {
                    kodetoko: { required: true },
                    namatoko: { required: true },
                    alamattoko: { required: true },
                    nomor:{ required: true }
                    },
            messages: {
                    kodetoko: {required: "Kode Toko harus diisi"},
                    namatoko: { required: "Nama Toko harus diisi" },
                    alamattoko: { required: "Alamat Toko harus diisi" },
                    nomor:{ required: "Nomor Handphone Harus diisi" }
                    },
            ...
            $('#editdataToko').validate({
            ignore: [],
            rules: {
                    ubahkodetoko: { required: true },
                    ubahnamatoko: { required: true },
                    ubahalamattoko: { required: true },
                    ubahnomor:{ required: true } 
                    },
            messages: {
                    ubahkodetoko: {required: "Kode Toko harus diisi"},
                    ubahnamatoko: { required: "Nama Toko harus diisi" },
                    ubahalamattoko: { required: "Alamat Toko harus diisi" },
                    ubahnomor:{ required: "Nomor Handphone Harus diisi" }
                    },
            errorPlacement: function(error, element) {
            if (element.is('select:hidden')) {
                error.insertAfter(element.next('.nice-select'));
    ...
    <script type="text/javascript">
        ...
        function fillmodalData(details){
            ...
            $('#ubahkodetoko').val(details[0]);
            $('#ubahnamatoko').val(details[1]);
            $('#ubahalamattoko').val(details[2]);
