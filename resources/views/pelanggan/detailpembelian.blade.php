        ...
        <div class="content pb-0">
            ...
            <div class="row" style="margin-bottom: 30px">
                <div class="col-lg-6 col-md-6">
                    <a href="pembelian"><h3 style="color:#8c8e8d;"><i style="font-size: 19px;" class=" fa fa-chevron-left "></i>    <b style="font-size: 21px">Kembali</b></h3></a>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                        <div class="card" >
                            <div class="card-body">
                                <b style="margin:0px 0px 0px 10px;">Detail Data Pembelian</b>
    ...
    <script type="text/javascript">
     ...
     <script type="text/javascript">
        ...
        function fillmodalData(details){
            ...
            $('#ubahjumlahbarang').val(details[2]);
            $('#ubahhargabarang').val(details[3]);
            $('#ubahtotalharga').val(details[4]);   
        }
    </script>
