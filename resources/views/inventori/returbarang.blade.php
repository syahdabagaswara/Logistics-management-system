                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class=" menu-item-has-children dropdown show open">
                        ...
                        <ul class="sub-menu children dropdown-menu show">
                            ...
                            <li><i class=" active fa fa-circle"></i><a class="active" href="returbarang">Retur Barang</a></li>
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><button type='button' class='editdata' data-toggle='modal' data-target='#largeModal' data-info="{{$returBarang->namaToko}},{{$returBarang->namaPegawai}},{{$returBarang->no_nota}},{{$returBarang->jumlah}},{{$returBarang->tanggal}}">Edit</button><button type='button' class='deletedata' data-toggle='modal' data-target='#deletedata' data-info="{{$returBarang->namaToko}},{{$returBarang->namaPegawai}},{{$returBarang->no_nota}},{{$returBarang->jumlah}},{{$returBarang->tanggal}}">Hapus</button></td>
                                                        </tr>
                                                        @endforeach
                                                    </tbody>
                          ...
                          var table = $('#bootstrap-data-table').DataTable({
                            ...
                            lengthChange: false,
                             buttons: [
                                { 
                                    extend: 'excel',
                                    title: 'Estu SAE - Stok Retur Barang',
                                    exportOptions: {
                                        columns: [ 0, 1, 2, 3, 4 ]
                                    }
                                }
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            messages: {
                    ...
                    ubahnamaegawai: { required: "Nama Pegawai harus diisi" },
